...
static const double inactiveopacity = 1;
static const int showbar            = 1;      /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "consolas-12", "JoyPixels:pixelsize=12" };
static const char dmenufont[]       = "consolas-12";
...
/* tagging */
static const char *tags[] = { "S", "h", "e", "r", "-", "N", "o", "o", "b" };
...
static const Rule rules[] = {
    ...
    { "Sakura",   NULL,       NULL,       0,            0,           -1,      0.7,     0.7 },
};
